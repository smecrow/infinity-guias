...
export default function DicasDeRedePlaceholder() {
  return (
    <main className="min-h-screen pt-24 pb-10 px-4 max-w-4xl mx-auto">
      ...
      >
        ...
        <p className="text-lg text-[var(--card-foreground)] opacity-70 max-w-xl mx-auto mb-8">
          Esta página será o espaço dedicado para ensinar as melhores práticas e dicas para extrair a melhor conexão. Aguardando o conteúdo!
        </p>
