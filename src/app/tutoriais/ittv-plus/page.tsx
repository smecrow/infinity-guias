...
export default function ITTVPlusPlaceholder() {
  return (
    <main className="min-h-screen pt-24 pb-10 px-4 max-w-4xl mx-auto">
      ...
      >
        ...
        <p className="text-lg text-[var(--card-foreground)] opacity-70 max-w-xl mx-auto mb-8">
          Tudo o que você precisa saber para configurar seu ITTV Plus e aproveitar a melhor programação na sua TV ou celular.
        </p>
